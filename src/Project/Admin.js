  ...
  <div class="app-content">
    ...
    <div class="products-area-wrapper tableView">
      ...
      <div class="products-row">
        ...
        <div class="product-cell image">
          <img src="./Images/image19.jpg" alt="product"/>
          <span>mini Jacket</span>
        </div>
        <div class="product-cell category"><span class="cell-label">Category:</span>jacket</div>
        <div class="product-cell status-cell">
          <span class="cell-label">Status:</span>
          <span class="status active">Active</span>
        </div>
        <div class="product-cell stock"><span class="cell-label">Stock:</span>3</div>
      ...
      <div class="products-row">
        ...
        <div class="product-cell image">
          <img src="./Images/jew4.jpg" alt="product"/>
          <span>Yellow Arabic Jewellry</span>
        </div>
        <div class="product-cell category"><span class="cell-label">Category:</span>Jewellries</div>
        <div class="product-cell status-cell">
          <span class="cell-label">Status:</span>
          <span class="status disabled">Disabled</span>
        </div>
        <div class="product-cell stock"><span class="cell-label">Stock:</span>4</div>
      ...
      <div class="products-row">
        ...
        <div class="product-cell image">
          <img src="./Images/image35.jpg" alt="product"/>
          <span>Afghani Cloth</span>
        </div>
        <div class="product-cell category"><span class="cell-label">Category:</span>Clothes</div>
        <div class="product-cell status-cell">
          <span class="cell-label">Status:</span>
          <span class="status active">Active</span>
        </div>
        <div class="product-cell stock"><span class="cell-label">Stock:</span>2</div>
      ...
      <div class="products-row">
        ...
        <div class="product-cell image">
          <img src="./Images/image12.jpg" alt="product"/>
          <span>Dreamy</span>
        </div>
        ...
        <div class="product-cell stock"><span class="cell-label">Stock:</span>1</div>
      ...
      <div class="products-row">
        ...
        <div class="product-cell image">
          <img src="./Images/jew1.jpg" alt="product"/>
          <span>Headwear</span>
        </div>
        <div class="product-cell category"><span class="cell-label">Category:</span>Jewellries</div>
        <div class="product-cell status-cell">
      ...
      <div class="products-row">
        ...
        <div class="product-cell image">
          <img src="./Images/image33.jpg" alt="product"/>
          <span>back jacket</span>
        </div>
        <div class="product-cell category"><span class="cell-label">Category:</span>jacket</div>
        <div class="product-cell status-cell">
          <span class="cell-label">Status:</span>
